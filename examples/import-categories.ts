...
console.log("==================================");
console.log();
console.log("This tool will import categories from JSON files into your Firefly III instance.");
console.log();
console.log("📁 Available category files:");
console.log("  • categories-pt-br.json - Portuguese categories (BR)");
console.log();
console.log("🔗 Usage:");
console.log("  deno run --allow-read --allow-env --allow-net src/tools/category-importer.ts");
console.log();
...
console.log("  • Or environment variables: FIREFLY_BASE_URL, FIREFLY_API_TOKEN");
console.log();
